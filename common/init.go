...
func printHelp() {
	fmt.Println("TokenPacks " + Version + " - The next-generation LLM gateway and AI asset management system supports multiple languages.")
	fmt.Println("Usage: tokenpacks [--port <port>] [--log-dir <log directory>] [--version] [--help]")
}
